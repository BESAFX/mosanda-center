app.factory("BankTransactionService",
    ['$http', '$log', function ($http, $log) {
        return {
            ...
            createTransfer: function (amount, fromBankId, toBankId, note) {
                return $http
                    .get("/api/bankTransaction/createTransfer/" + amount + "/" + fromBankId + "/" + toBankId + "/" + note)
                    .then(function (response) {
                        return response.data;
                    });
            },
            createExpense: function (bankTransaction) {
                return $http.post("/api/bankTransaction/createExpense", bankTransaction).then(function (response) {
                    return response.data;
                });
            },
            findOne: function (id) {
